...
for task in tasks:
    for ses in ['LR','RL']:
        ...
        cifti.write('%s/%s/%s_%s/%s_%s_10k_Atlas_MSMAll_clean_24nuisance.reg_lin.trend_filt_sm6_R1LRRL_hyp.dtseries.nii' % (tempdir,sub,task,ses,task,ses),tmpwrite,tmpimg[1])
